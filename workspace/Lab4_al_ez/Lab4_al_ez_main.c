...
//    AdcaRegs.ADCINTFLGCLR.bit.ADCINT1 = 1; //make sure INT1 flag is cleared
    ...
    // Enable the 6th interrupt source of group 1
    ...
    while(1)
    {
        if (UARTPrint == 1 ) {
            //Part 3 Print
            serial_printf(&SerialA,"w1 = %.2f, w2 = %.2f, w3 = %.2f, w4 = %.2f\r\n",adcc2degs,adcc3degs,adcc4degs,adcc5degs);
            UART_printfLine(1,"xk = %.2f, yk = %.2f \r\n",xk,yk);


            // Part 2 Print
//            serial_printf(&SerialA,"xk = %.2f, yk = %.2f \r\n",xk,yk);
//            UART_printfLine(1,"xk = %.2f, yk = %.2f \r\n",xk,yk);

// Part 1 print
//			serial_printf(&SerialA,"ADC Voltage = %.2f \r\n",adcd0scaled);
//            UART_printfLine(1,"ADC Voltage = %.2f \r\n",adcd0scaled);
            UARTPrint = 0;
        }
    }
}
...
__interrupt void ADCD_ISR (void)
{
    ...
    adcd0scaled = adcd0result*(3.0/4095.0);
